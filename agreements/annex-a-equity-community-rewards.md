...
| Topic        | Key Points                                                                 |
|--------------|-----------------------------------------------------------------------------|
| Equity       | Early Contributors: ≤1%, Board‑approved, vesting 2y. Core Contributors: performance‑based, discretionary, Board‑approved. |
| Tokens       | Non‑financial, non‑transferable, illustrative only.                         |
| Transparency | Optional quarterly reports, anonymized, informational only, published in PDF + Registry snapshot. |
| Governance   | All actions approved by Board, aligned with MEI and Contributor Agreement.  |
| Compliance   | No implied rights; separate signed agreements required.                     |
| Versioning   | Semantic versioning, immutable logs, contributor notification within 7 days. |
